...
**Problem Statement: Offline Video Segmentation & ROI Detection using Motion Estimation**<br>
Team: The Fellowship of the Ring

The outputs here are real and are generated by the pipeline on a sample exam-hall CCTV camera recording.
